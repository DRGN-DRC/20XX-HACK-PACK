...
checkIfCharacterIsInActionStateHeActivatedTurboWith:
...
mr r3,r31
bl r14,0x800d5fb0			#check for squat
mr r3,r31
bl r14,0x800c9468			#check for walk
#add a check for turn
nocrouch:
turbo:
branch r14,0x800c9754
