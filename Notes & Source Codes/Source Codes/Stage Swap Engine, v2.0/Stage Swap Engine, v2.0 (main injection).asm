...
##<SwapTableFileString> # Need a known address for this string
##.string "StageSwapTable.bin"



# Test breakpoints:
# 8025bb40 - injection site
# 80194520 - start of BYTE_OVERWRITE_SAVE
# 8025bb48 - right after returning from above function (after injection site)