...
lbz r14,0x2293(player)

checkIfTurboIsEnabled:
cmpwi r14,40
beq original
addi r14,r14,1
stb r14,0x2293(player)

checkForGrab:
lwz r14,0x1a58(player)
cmpwi r14,0x0
beq checkAirState
b original
...
stb r0,0x2292(player) #set turboflag
mr r3,r30 
lwz r0,0xe0(player)
cmpwi r0,1
beq customInterruptAir

customInterruptGround:
bl r14,0x800c9614
b exit
...
li r14,0x0
rlwimi r0,r14,0,31,31
stb r0,0x2292(player)
branch r14,0x8006b80c
