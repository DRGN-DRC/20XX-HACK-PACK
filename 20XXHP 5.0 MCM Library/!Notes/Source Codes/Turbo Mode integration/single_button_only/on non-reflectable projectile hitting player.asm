...
#check if reflectable
lbz	r4, 0x0042 (r23)
rlwinm.	r4, r4, 29, 31, 31
bne	exit

#get owner
lwz	r4,0x002c(r26)		#get item data
lwz	r4,0x0518(r4)		#get owner
lwz	r4,0x002C(r4)		#get owner data

#give turbo
li r5,0
stb r5,0x2293(player)

lwz r5,0x10(player)			#store move id that hit
sth r5,0x2290(player)
